...
<div class="container">
    <div class="card card-module">
        ...
        <p class="text-secondary">Enter your feedback below. Max allowed characters: 250.</p>

        <!-- Feedback Input -->
        <textarea id="feedbackInput" maxlength="250" class="form-control" placeholder="Type your feedback here..."></textarea>

        <!-- Character counter -->
        <div class="char-limit">
            <span id="currentCount">0</span>/250 characters used
        </div>
