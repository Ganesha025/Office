...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($currentDay < 0 || $currentDay > 100) {
        $errors['currentDay'] = 'Current day must be 0-100';
    }

    if ($daysUntilMission < 0 || $daysUntilMission > 100) {
        $errors['daysUntilMission'] = 'Days until mission must be 0-100';
    }
...
.error { color:#e74c3c; font-size:14px; grid-column:2; }
...
function restrictNumber(e, min, max) {
    ...
    if(e.value < min && e.value !== '') e.value = min;
...
<form method="post" autocomplete="off" novalidate>
    ...
    <input type="text" id="nameField" name="name" placeholder="Enter character name" required maxlength="20" oninput="validateName(this)" required>
    ...
    <label>Mission Code Name</label>
    <select name="missionCode" required>
    ...
    <select name="missionLocation" required>
    ...
    <select name="missionTarget" required>
    ...
    <input type="text" name="currentDay" placeholder="0-100" maxlength="3" oninput="restrictNumber(this,0,100)" required>
    <div class="error"><?php echo $errors['currentDay'];?></div>

    <label>Days Until Mission</label>
    <input type="text" name="daysUntilMission" placeholder="0-100" maxlength="3" oninput="restrictNumber(this,0,100)">
