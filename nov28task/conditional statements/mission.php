...
<main class="flex-grow flex items-center justify-center">
    <form method="POST" class="bg-white shadow-lg rounded-xl p-10 w-full max-w-md space-y-6">
        ...
        <div>
            <label class="block text-gray-700 mb-1">Hero Rank</label>
            <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-500">
                ...
                <select name="heroRank" required class="w-full outline-none">
        ...
        <div>
            <label class="block text-gray-700 mb-1">Villain Status</label>
            <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-500">
        ...
        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-semibold transition">Submit Mission</button>
