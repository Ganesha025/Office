...
function validateText() {
    ...
    validateFindWord(); // re-validate word to find when text changes
}
...
<div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-4xl">
    ...
    <form method="post" class="space-y-6" novalidate>
        <!-- Text area -->
        <div>
            <label class="block font-semibold mb-2 text-gray-700">Enter Text (Max 250 words):</label>
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                <label class="block font-semibold mb-2 text-gray-700">Word to Find (Max 20 chars):</label>
            ...
            <div>
                <label class="block font-semibold mb-2 text-gray-700">Replace With (Max 20 chars):</label>
